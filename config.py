...
AUTO_REST_INTERVAL_MINUTES = (75, 180) # สุ่มพักบอททุกๆกี่นาที (เช่น วิ่ง 45 ถึง 75 นาทีแล้วจะพัก)
AUTO_REST_DURATION_MINUTES = (1, 2)   # สุ่มระยะเวลาการพักแต่ละรอบกี่นาที (เช่น พัก 3 ถึง 8 นาที)
