...
INTERRUPTS = {
    ...
    # ⚠️ ยังไม่มี template confirm_inactive.png — ใช้คำสั่ง --capture สร้างรูปก่อนจึงจะเปิดใช้งานได้
    # เมื่อสร้าง template เสร็จ ให้ลบเครื่องหมาย # ด้านล่างเพื่อเปิดใช้งาน
    # "confirm_inactive": {
